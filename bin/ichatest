...
if [ -f data/env/${envName}.yaml ] && [ -f schemas/data/env/env_file.json ] ; then ajv ${ajvParams} validate -s schemas/data/env/env_file.json -d data/env/${envName}.yaml -c ${HOME}/node_modules/ajv-formats/dist/index.js; fi
