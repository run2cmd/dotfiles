...
autocmd! TabNewEntered * startinsert

" Shortcuts
"let mapleader = ' '
tmap <C-W>n <C-\><C-N>
tmap <C-W>c <C-\><C-N>:tab new term://cmd /k clink inject<CR>
tmap <C-W>k <C-\><C-N>:tabnext<CR>
tmap <C-W>j <C-\><C-N>:tabprevious<CR>
nmap <C-W>c <C-\><C-N>:tab new term://cmd /k clink inject<CR>
nmap <C-W>k <C-\><C-N>:tabnext<CR>
nmap <C-W>j <C-\><C-N>:tabprevious<CR>
